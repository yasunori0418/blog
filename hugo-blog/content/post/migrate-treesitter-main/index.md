...
執筆時現在(2025-08-13)、[nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter)のGitHub上のデフォルトブランチは`master`になっていますが、今後は`main`ブランチに移行するようです。
...
アナウンス自体は別の経路でも確認はしていましたが、nvim-treesitterの移行に対応できていないプラグインもあったので移行作業は見送っていました。
