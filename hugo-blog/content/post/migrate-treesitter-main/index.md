...
どちらも[nvim-treesitter](https://github.com/nvim-treesitter)で管理されている物ですので、参照するブランチを`master`から`main`に変更すると対応するドキュメントを確認できます。
...
<!-- textlint-disable -->
[^1]: [scfg](https://github.com/rockorager/tree-sitter-scfg)というFileTypeに対応するらしい。設定言語っぽいが知らべても使われている物が見つからなかった。
