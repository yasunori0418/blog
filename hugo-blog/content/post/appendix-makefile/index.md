...
あと個人的にはタスクランナーとして開発されたツールのデファクト的なものがなかったり、人によって好みが別れると思っています。\
...
とはいえ環境構築の上では止むを得ずterminalを触るので、追加のツールは少ない方が良いのです。\
...
いろいろな手段を考えるのは好きですが、これは自分勝手になってはいけないのです。\
誰かのための環境構築は、快楽的であってはいけないのです。\
誰もが便利にチーム開発を順調に進めるための**地盤**でなくてはいけないのです。

「誰かのために優しくありたい。」

これが自分の環境構築に対するポリシーです。
