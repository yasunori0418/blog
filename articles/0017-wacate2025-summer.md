...
海外や官公庁案件で必要になったことから話題になり、この頃から「一人QA」という言葉が生まれたそうです。
...
現在翻訳に関わっている方が「今はAI時代だからね～」と言いつつ、最強の翻訳プロンプトが存在するという話は時代の変化を感じさせて面白かったです。

「レビューはテストに入りますか？」という議論も技術的に興味深い内容でした。
一般的にレビューは静的テストに該当しますが、ISO29119/IEC/IEEEの標準ではテスト技法として扱われていないなど、標準によって解釈が分かれる部分があることを知りました。
また、TDDについても「テストではなく開発技法である」という明確な位置づけや、最近のlinterのような静的解析も一種のテストと言える、という現代的な視点も学びになりました。
