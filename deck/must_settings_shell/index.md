...
- **キーワード入力時にスニペット自動展開(abbrev snippet)**
  - 短いキーワードを打つと、定義したコマンド全体に展開
  - **コマンドの意味を常に思い出しながら使用可能**
- fzfを利用した曖昧検索による補完機能
  - Gitコマンドの補完、ユーザー定義の補完に対応
  - インタラクティブに選択できるため、コマンドやオプションを学習しやすい
- ZLEユーティリティでシェルの操作性を向上
  - スニペットのプレースホルダ移動、履歴検索など
